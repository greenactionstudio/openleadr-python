...
class OpenADRClient:
    ...
    def __init__(self, ven_name, vtn_url, debug=False, cert=None, key=None,
        ...
        ##The value in the report was generated by this callback function
        ...
        self.pending_reports = None # Holds reports that are waiting to be sent
        
        ## Never initilize a queue outside the scope of the loop context. It will cause some problme where queen will be set in 
        # different event loop. And the queue in different queue can never treated as the same one queue!!!
